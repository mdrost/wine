...
static ULONG WINAPI ICMStream_fnRelease(IAVIStream* iface)
{
  ...
  if (ref == 0) {
    ...
    if (This->lpbiCur != NULL) {
      heap_free(This->lpbiCur);
      This->lpbiCur = NULL;
      This->lpCur   = NULL;
    }
    if (This->lpbiOutput != NULL) {
      heap_free(This->lpbiOutput);
      This->lpbiOutput = NULL;
      This->cbOutput   = 0;
    }
    if (This->lpbiInput != NULL) {
      heap_free(This->lpbiInput);
      This->lpbiInput = NULL;
      This->cbInput   = 0;
    }
					     ...
					     LPVOID format, LONG formatsize)
{
  ...
  if (This->lpbiInput == NULL) {
    ...
    This->lpbiInput = heap_alloc(formatsize);
    if (This->lpbiInput == NULL)
      return AVIERR_MEMORY;
    ...
    This->lpbiOutput = heap_alloc(size);
    if (This->lpbiOutput == NULL)
      return AVIERR_MEMORY;
    This->cbOutput = size;
    ...
    This->lpbiCur = heap_alloc(This->cbOutput + size);
    if (This->lpbiCur == NULL)
      return AVIERR_MEMORY;
	...
	This->lpbiPrev->biSizeImage =
      ...
      This->lpbiPrev = heap_realloc(This->lpbiPrev, size);
      if (This->lpbiPrev == NULL)
	return AVIERR_MEMORY;
