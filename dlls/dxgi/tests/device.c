...
static void test_output(void)
{
    ...
    modes = heap_alloc_zero(sizeof(*modes) * (mode_count + 10));
...
static void test_find_closest_matching_mode(void)
{
    ...
    modes = heap_alloc_zero(sizeof(*modes) * mode_count);
        ...
        IDXGIAdapter *adapter, const struct swapchain_fullscreen_state *initial_state)
{
    ...
    output_monitor_info = heap_alloc(output_count * sizeof(*output_monitor_info));
