...
@ stdcall glXChooseFBConfig(ptr long ptr ptr)
@ stdcall glXChooseVisual(ptr long ptr)
@ stdcall glXCopyContext(ptr ptr ptr long)
@ stdcall glXCreateContext(ptr ptr ptr int)
@ stdcall glXCreateGLXPixmap(ptr ptr ptr)
@ stdcall glXCreateNewContext(ptr ptr long ptr int)
@ stdcall glXCreatePbuffer(ptr ptr ptr)
@ stdcall glXCreatePixmap(ptr ptr ptr ptr)
@ stdcall glXCreateWindow(ptr ptr ptr ptr)
@ stdcall glXDestroyContext(ptr ptr)
@ stdcall glXDestroyGLXPixmap(ptr ptr)
@ stdcall glXDestroyPbuffer(ptr ptr)
@ stdcall glXDestroyPixmap(ptr ptr)
@ stdcall glXDestroyWindow(ptr ptr)
@ stdcall glXGetClientString(ptr long)
@ stdcall glXGetConfig(ptr ptr long ptr)
@ stdcall glXGetCurrentContext()
@ stdcall glXGetCurrentDisplay()
@ stdcall glXGetCurrentDrawable()
@ stdcall glXGetCurrentReadDrawable()
@ stdcall glXGetFBConfigAttrib(ptr ptr long ptr)
@ stdcall glXGetFBConfigs(ptr long ptr)
@ stdcall glXGetProcAddress(ptr)
@ stdcall glXGetSelectedEvent(ptr ptr ptr)
@ stdcall glXGetVisualFromFBConfig(ptr ptr)
@ stdcall glXIsDirect(ptr ptr)
@ stdcall glXMakeContextCurrent(ptr ptr ptr ptr)
@ stdcall glXMakeCurrent(ptr ptr ptr)
@ stdcall glXQueryContext(ptr ptr long ptr)
@ stdcall glXQueryDrawable(ptr ptr long ptr)
@ stdcall glXQueryExtension(ptr ptr ptr)
@ stdcall glXQueryExtensionsString(ptr long)
@ stdcall glXQueryServerString(ptr long long)
@ stdcall glXQueryVersion(ptr ptr ptr)
@ stdcall glXSelectEvent(ptr ptr long)
@ stdcall glXSwapBuffers(ptr ptr)
@ stdcall glXUseXFont(ptr long long long)
@ stdcall glXWaitGL()
@ stdcall glXWaitX()
