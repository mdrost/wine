...
#ifndef __WINE_GLX_DRIVER_H
#define __WINE_GLX_DRIVER_H

#ifndef WINE_GLAPI
#define WINE_GLAPI
#endif

#define WINE_GLX_DRIVER_VERSION 8

struct opengl_funcs
{
    struct
    {
        void       (WINE_GLAPI *p_glXCopyContext)( Display *dpy, GLXContext src, GLXContext dst, unsigned long mask );
        GLXContext (WINE_GLAPI *p_glXCreateContext)( Display *dpy, XVisualInfo *vis, GLXContext shareList, Bool direct );
        void       (WINE_GLAPI *p_glXDestroyContext)( Display *dpy, GLXContext ctx );
        __GLXextFuncPtr (WINE_GLAPI *p_glXGetProcAddress)( const GLubyte *procName );
        Bool       (WINE_GLAPI *p_glXMakeCurrent)( Display *dpy, GLXDrawable drawable, GLXContext ctx );
        void       (WINE_GLAPI *p_glXSwapBuffers)( Display *dpy, GLXDrawable drawable );
    } glx;
    ...
    struct
    {
        ...
        GLXContext (WINE_GLAPI *p_glXCreateContextAttribsARB)( Display *dpy, GLXFBConfig config, GLXContext share_context, Bool direct, const int *attrib_list );
        void       (WINE_GLAPI *p_glXSwapIntervalEXT)( Display *dpy, GLXDrawable drawable, int interval );
    } ext;
};

#define ALL_GLX_FUNCS \
    USE_GL_FUNC(glAccum) \
