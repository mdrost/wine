...
NTSYSAPI NTSTATUS  WINAPI NtClose(HANDLE) __attribute__((deprecated));
...
NTSYSAPI NTSTATUS  WINAPI RtlExpandEnvironmentStrings_A(PCSTR, const ANSI_STRING*, ANSI_STRING*, ULONG*);
...
NTSYSAPI NTSTATUS  WINAPI RtlQueryEnvironmentVariable_A(PSTR,PANSI_STRING,PANSI_STRING);
